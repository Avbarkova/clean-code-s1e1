...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task input-task saved-mode";
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("edit-mode-tasks");
  ...
  listItem.classList.toggle("edit-mode-tasks");
};
...
var taskCompleted=function(){
  ...
  var label=listItem.querySelector("label");
  label.className = "task completed-task";
